...
function render(imageData) {
  ...
  worker.postMessage([imageData, config]); // calculate the emojis
...
function toImageData(bitmap, imgWidth, imgHeight, width) {
  ...
  ctx.drawImage(bitmap, 0, 0, bitmap.width, bitmap.height, 0, 0, width, resizedHeight);
...
},{"./worker.js":[["worker.ab30da2c.js","worker.js"],"worker.ab30da2c.js.map","worker.js"]}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
